...
const createUserFormSchema = z.object({
  ...
  name: z.string().nonempty('O nome é obrigatério')
  .transform(name => {
      ...
      onSubmit={handleSubmit(createUser)}
       ...
       >
        ...
        <div className="flex flex-col gap-1">
          <input 
            type="number"
            className="w-16 border border-zinc-500 shadow-sm rounded h-10 px-3 bg-zinc-700 text-white" 
